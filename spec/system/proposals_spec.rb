...
describe "Proposals" do
  ...
  context "Concerns" do
    ...
    it_behaves_like "remotely_translatable", :proposal, "proposals_path", {}, provider: provider
    it_behaves_like "remotely_translatable", :proposal, "proposal_path", { id: "id" }, provider: provider
